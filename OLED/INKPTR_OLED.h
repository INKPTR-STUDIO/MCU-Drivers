...
typedef enum {INKPTR_OLED_Mode_Opposite = 0, INKPTR_OLED_Mode_Normal} INKPTR_OLED_Mode;
typedef enum {INKPTR_OLED_Switch_DISABLE = 0, INKPTR_OLED_Switch_ENABLE} INKPTR_OLED_Switch;
